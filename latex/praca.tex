...
% ZMIENNE TEKSTOWE (jw)
\newcommand{\priohp}{\textcolor{blue}{\textbf{Wysoki dodatni}}}
\newcommand{\priomp}{\textcolor{cyan}{\textbf{Średni dodatni}}}
\newcommand{\priol}{\textcolor{gray}{\textbf{Niski}}}
\newcommand{\priomn}{\textcolor{orange}{\textbf{Średni ujemny}}}
\newcommand{\priohn}{\textcolor{red}{\textbf{Wysoki ujemny}}}
...
% Pozwala nazywać linki do rozdziałów ich pełnymi nazwami
\usepackage{nameref}
...
% Pozwala kontrolować umiejscowienie floatowych elementów, np. figure
\usepackage{placeins}
...
\hyphenation{HParam StopCond Console
        Schaeffer in-tui-cja GENERATIONS 
        wszy-stkich ko-lu-mnę każ-da od-leg-łość
	...
	\begin{titlingpage}
		...
		\begin{center}
			\begin{picture}(430,500)
				\put(75,590){\makebox(0,0)[l]{\huge \textbf{Politechnika Wrocławska}}}
				\put(65,565){\makebox(0,0)[l]{\Large \textbf{Wydział Informatyki i Telekomunikacji}}}
...
% Tytuł pracy
				...
				\centering
				\LARGE \textbf{Algorytm Minimax dla gry w Warcaby}
                \end{minipage}
				}
% Autor pracy
