...
\section{Warcaby}
\input{slajdy/1-1_warcaby.tex}	% warcaby
\input{slajdy/1-2_angielskie.tex}	% warcaby

\section{Algorytmy}
% \input{slajdy/2-1_minimax1.tex}	% minimax
\input{slajdy/2-2_minimax2.tex}	% minimax przyklad
\input{slajdy/2-3_ocena.tex}	% ocena
\input{slajdy/2-4_genetyk1.tex}	% algorytm genetyczny
% \input{slajdy/2-5_genetyk2.tex}	% szczegóły genetyka

\section{Implementacja}
\input{slajdy/3-1_jezyk.tex}
\input{slajdy/3-2_programy.tex}
% \input{slajdy/3-3.tex}
% \input{slajdy/3-4.tex}
% \input{slajdy/3-5.tex}

\section{Wyniki}
\input{slajdy/4-1_param.tex}
\input{slajdy/4-2_glebokosci.tex}
\input{slajdy/4-3_rozwoj.tex}
% \input{slajdy/4-4.tex}

% \section{Zakończenie}
% \input{slajdy/5-1.tex}
% \input{slajdy/5-2.tex}
% \input{slajdy/5-3.tex}

\begin{frame}[plain,noframenumbering]{Bibliografia}
	\begin{center}
		\begin{itemize}
